...
func (m UserModel) GetForToken(tokenScope, tokenPlaintext string) (*User, error) {
	log.Println("GetForToken()")
	// Calculate the SHA-256 of the plaintext token provided by the client.
	...
	// Create a slice containing the query arguments. Notice how we user the [:] operator
	// to get a slice containing the token hash, rather than passing in the array (which
	// is not supported by the pq driver), and that we passw the currenttime as the
